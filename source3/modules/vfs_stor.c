...
//»·····rstrcpy(myEnv.rodsHost, irods_host, NAME_LEN);
»·······irods_port = lp_parm_int(snum, "stor", "irods_port", 1247);
//»·····myEnv.rodsPort = irods_port;
»·······irods_zone_name = lp_parm_const_string(snum, "stor", "irods_zone_name",
»·······»·······»·······»······· NULL);
//»·····rstrcpy(myEnv.rodsZone, irods_zone_name, NAME_LEN);
»·······»·······»·······»······· NULL);
//»·····rstrcpy(myEnv.rodsZone, irods_zone_name, NAME_LEN);
»·······irods_auth_scheme = lp_parm_const_string(snum, "stor",
»·······»·······»·······»······· "irods_auth_scheme", NULL);
»·······irods_user_name = handle->conn->session_info->
»·······»·······»·······»·······unix_info->sanitized_username;
//»·····rstrcpy(myEnv.rodsUserName, irods_user_name, NAME_LEN);
...
»·······dvstatus = -1;
»·······DEBUG(1, ("[VFS_STOR] - error number, rc: %i\n", dvstatus));
»·······
»·······if (dvstatus < 0) {
